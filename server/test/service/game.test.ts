...
describe("game, turn and players state in update", () => {
    ...
    it("should update player money for using renda", async () => {
        ...
        expect(turn.getBlocker()).toBe(undefined);
    ...
    it("should update player money for using bloquear after ajuda externa", async () => {
        ...
        expect(turn.getContester()).toBe(undefined);
        expect(turn.getBlocker()).toBe(gameClient.secondPlayer());
        expect(turn.getBlockContester()).toBe(undefined);
        expect(game.getAsylumCoins()).toBe(0);
    ...
    it("should update player money for using contestar after bloquear after ajuda externa", async () => {
        ...
        expect(turn.getContester()).toBe(undefined);
        expect(turn.getBlocker()).toBe(gameClient.secondPlayer());
        expect(turn.getBlockContester()).toBe(gameClient.firstPlayer());
        expect(game.getAsylumCoins()).toBe(0);
        expect(game.getLastTurn()).not.toBe(turn);
    });
    ...
    it("should update player money for using contestar after taxar", async () => {
        ...
        expect(turn.getAllCards()).toStrictEqual([0, 0]);
        expect(turn.getAllCardTypes()).toStrictEqual([CardType.DUQUE]);
        expect(turn.getContester()).toBe(gameClient.secondPlayer());
        expect(turn.getBlocker()).toBe(undefined);
        expect(turn.getBlockContester()).toBe(undefined);
        expect(game.getAsylumCoins()).toBe(0);
        expect(game.getLastTurn()).not.toBe(turn);
    ...
    it("should update player money for using contestar after bloquear after extorquir when the player have less than the extorquir amount", async () => {
        const gameClient = await GameClient.create(
            [
                [ ["moedasIniciais"], 1 ]
            ],
        ...
        gameClient.firstPlayerDo(Action.EXTORQUIR, CardType.CAPITAO, 1, gameClient.secondPlayer().name);
    ...
    it("should update player money for using contestar after extorquir when the player have less than the extorquir amount", async () => {
        const gameClient = await GameClient.create(
            [
                [ ["moedasIniciais"], 1 ]
            ],
    ...
    it("should update player money for using continuar after extorquir when the player have less than the extorquir amount", async () => {
        const gameClient = await GameClient.create(
            [
                [ ["moedasIniciais"], 1 ]
            ],
...
describe("globally contestable actions must be globally contested", () => {
    ...
    it("should loose contesting when third player use contestar after extorquir", async () => {
        ...
        expect(turn.getAllCardTypes()).toStrictEqual([CardType.CAPITAO]);
        expect(turn.getAllCards()).toStrictEqual([0, 0]);
        expect(turn.getContester()).toBe(gameClient.thirdPlayer());
        expect(turn.getBlocker()).toBe(undefined);
        expect(turn.getBlockContester()).toBe(undefined);
        expect(game.getAsylumCoins()).toBe(0);
        expect(game.getLastTurn()).not.toBe(turn);
